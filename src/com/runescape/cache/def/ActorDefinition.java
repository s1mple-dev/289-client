...
public class ActorDefinition {
    ...
    public static void method212(Archive class47) {
        ...
        int i = 2;
        for (int j = 0; j < ActorDefinition.anInt276; j++) {
            ActorDefinition.anIntArray277[j] = i;
            i += class44_sub3_sub2.readUnsignedShort();
        }
        ActorDefinition.cache = new ActorDefinition[20];
        for (int k = 0; k < 20; k++) {
            ActorDefinition.cache[k] = new ActorDefinition();
        }
    }

    public static void method213(byte byte0) {
        try {
            ActorDefinition.aClass39_307 = null;
            ActorDefinition.anIntArray277 = null;
            if (byte0 != 42) {
                return;
            } else {
    ...
    public static ActorDefinition method214(int i) {
        ...
        ActorDefinition.anInt280 = (ActorDefinition.anInt280 + 1) % 20;
        ActorDefinition class12 = ActorDefinition.cache[ActorDefinition.anInt280] = new ActorDefinition();
        ActorDefinition.buffer.offset = ActorDefinition.anIntArray277[i];
        class12.aLong281 = i;
        class12.method215(false, ActorDefinition.buffer);
        return class12;
    }
